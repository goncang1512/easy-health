      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            border: Border.all(
              color: isEditable && _isEditing ? primaryColor : Colors.grey.shade300
            ),
            borderRadius: BorderRadius.circular(8),
            color: isEditable && _isEditing ? Colors.white : Colors.grey.shade50,
          ),
          ...
          child: isEditable && _isEditing
              ? TextField(
                  ...
                  keyboardType: label == "Telepon" ? TextInputType.phone : TextInputType.text,
